...
mod tests {
    ...
    fn cidr_matches_addresses_inside() {
        assert!(list().matches("192.168.1.246"));
    ...
    fn full_prefix_cidr_matches_single_address() {
        let l = BypassList::parse("192.168.1.246/32");
        assert!(l.matches("192.168.1.246"));
        assert!(!l.matches("192.168.1.247"));
    }
}
